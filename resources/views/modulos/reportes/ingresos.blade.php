...
@section('content')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item ">
            Ingreso de mercaderia entre fechas
        </li>
    </ol>
    <p class="lead">Reporte - Ingreso de mercaderia entre fechas</p>
    <form action="{{ route('reportes.reporte_ingresos') }}" method="get" target="_blank">
